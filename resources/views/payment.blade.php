  ...
  <section class="bg-darkGrey relative py-[70px]">
    <div class="container">
      ...
      <div class="flex items-center gap-5 lg:justify-between">
        <!-- Form Card -->
        <form action="{{route('front.payment.update', $booking->id)}}" class="bg-white p-[30px] pb-10 rounded-3xl max-w-[490px] w-full" method="POST" id="checkoutForm">
          @csrf
          @method('post')
          <div class="flex flex-col gap-[30px]">
            <div class="flex flex-col gap-4">
              ...
              <div class="flex items-center justify-between">
                ...
                <p class="text-base font-semibold">
                  Rp {{number_format($booking->item->price)}} per day
                </p>
              </div>
              <!-- Items -->
              <div class="flex items-center justify-between">
              ...
              <div class="flex items-center justify-between">
                ...
                <p class="text-base font-semibold">
                  ...
                  <!-- ($booking->item->price) + ($booking->item->price * $booking->start_date->diffInDays($booking->end_date) * 0.1) -->
                </p>
              </div>
            </div>
            <div class="flex flex-col gap-4">
