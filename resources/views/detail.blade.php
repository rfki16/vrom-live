<x-front-layout>
    ...
    <div class="container">
      ...
      <div class="grid grid-cols-12 gap-[30px]">
        ...
        <div class="col-span-12 lg:col-span-8">
          @php
          $thumbnails = collect(json_decode($item->photos))->map(function($photo, $key) {
          return [
          'id' => $key,
          ...
          <div class="bg-white p-4 rounded-[30px] flex flex-col gap-4"
            id="gallery"
            data-thumbnails='@json($thumbnails)'>
  ...
  <script>
    ...
    const rawData = document.getElementById('gallery').dataset.thumbnails;
    const parsedThumbnails = JSON.parse(rawData); // ini penting
    ...
    createApp({
      ...
      mounted() {
  console.log("Thumbnails data:", this.thumbnails);
}
    }).mount('#gallery');
